...
export class VacacionController {
  constructor(private readonly service: VacacionService) {}
  ...
  @UseGuards(JwtAuthGuard)
  @Get(':id')
  findOne(@Param('id') id: string): Promise<Vacacion | null> {
  ...
  @UseGuards(JwtAuthGuard)
  @Post()
  create(@Body() dto: VacacionDTO): Promise<Vacacion | null> {
