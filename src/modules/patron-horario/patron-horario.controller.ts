...
@Controller('patronesHorario')
export class PatronHorarioController {
  constructor(private readonly service: PatronHorarioService) {}
  ...
  @UseGuards(JwtAuthGuard)
  @Get(':id')
  findOne(@Param('id') id: string): Promise<PatronHorario | null> {
  ...
  @UseGuards(JwtAuthGuard)
  @Post()
  create(@Body() dto: PatronHorarioDTO): Promise<PatronHorario | null> {
