import{c as g}from"./chunk-4Q3JVAKG.js";import{B as I,J as oe,L as ne,b as J,ha as re,i as ee,ka as se,la as y,m as te,oa as ae,pa as le,r as ie,sa as ce,ua as pe}from"./chunk-F2X7M4DW.js";import{c as G,d as L,f as v,g as b,h as O}from"./chunk-WCGJ44IN.js";import{B as X,D as m,m as W,p as q,s as K,t as U}from"./chunk-J6775IRK.js";import{$ as p,Ab as R,Fc as f,Gb as w,Gc as Y,Hb as Z,Mb as B,Rb as u,Sa as $,Sb as r,Ta as H,Tb as M,Ub as j,V as P,Vb as k,W as D,Xb as T,Yb as S,fa as l,ga as c,hb as z,hc as N,ia as C,ib as E,jc as Q,kc as x,lb as A,nb as d,oa as _,pa as V,vb as F,wb as h}from"./chunk-VDH5VFWZ.js";var he=["content"],ue=["*"],fe=(t,s)=>({showTransitionParams:t,hideTransitionParams:s}),me=(t,s)=>({value:t,params:s}),ve=t=>({closeCallback:t});function be(t,s){}function ye(t,s){t&1&&d(0,be,0,0,"ng-template")}function ge(t,s){if(t&1){let e=B();w(0,"div",1),u("click",function(o){l(e);let n=r();return c(n.onOverlayClick(o))})("@animation.start",function(o){l(e);let n=r();return c(n.onAnimationStart(o))})("@animation.done",function(o){l(e);let n=r();return c(n.onAnimationEnd(o))}),w(1,"div",2),u("click",function(o){l(e);let n=r();return c(n.onContentClick(o))})("mousedown",function(o){l(e);let n=r();return c(n.onContentClick(o))}),j(2),d(3,ye,1,0,null,3),Z()()}if(t&2){let e=r();R(e.styleClass),h("ngClass","p-popover p-component")("ngStyle",e.style)("@animation",x(13,me,e.overlayVisible?"open":"close",x(10,fe,e.showTransitionOptions,e.hideTransitionOptions))),F("aria-modal",e.overlayVisible)("aria-label",e.ariaLabel)("aria-labelledBy",e.ariaLabelledBy),H(3),h("ngTemplateOutlet",e.contentTemplate||e._contentTemplate)("ngTemplateOutletContext",Q(16,ve,e.onCloseClick.bind(e)))}}var Ce=({dt:t})=>`
.p-popover {
