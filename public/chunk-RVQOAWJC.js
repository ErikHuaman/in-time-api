import{ka as q,la as g,pa as A,sa as P}from"./chunk-F2X7M4DW.js";import{B as O,m as Q,p as E,t as N}from"./chunk-J6775IRK.js";import{$ as T,Ab as I,Fc as B,Gb as u,Hb as d,Ib as x,Jb as M,Kb as w,Sb as l,Ta as o,Tb as D,Ub as F,V as v,Vb as f,W as h,Xb as m,Yb as y,ac as j,bc as S,hb as b,hc as z,ia as p,ib as C,lb as $,nb as r,wb as i,zb as k}from"./chunk-VDH5VFWZ.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
